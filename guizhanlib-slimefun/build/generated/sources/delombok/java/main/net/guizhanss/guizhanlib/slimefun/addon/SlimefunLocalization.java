...
public class SlimefunLocalization extends MinecraftLocalization {
    ...
    public SlimefunItemStack getItemBy(String key, String id, ItemStack itemStack, String... extraLore) {
        ...
        return new SlimefunItemStack((idPrefix + id).toUpperCase(Locale.ROOT), itemStack, getString(key + "." + id + KEY_NAME), lore.toArray(String[]::new));
    }
    ...
    public RecipeType getRecipeType(String id, Material material, String... extraLore) {
        return new RecipeType(new NamespacedKey(getPlugin(), id), getItemBy(recipesKey, id, material, extraLore));
    }
    ...
    public RecipeType getRecipeType(String id, String texture, String... extraLore) {
        return new RecipeType(new NamespacedKey(getPlugin(), id), getItemBy(recipesKey, id, texture, extraLore));
    }
    ...
    public RecipeType getRecipeType(String id, ItemStack itemStack, String... extraLore) {
        return new RecipeType(new NamespacedKey(getPlugin(), id), getItemBy(recipesKey, id, itemStack, extraLore));
    }
     ...
     * The key of ItemGroups in language file.
     */
    public void setItemGroupKey(final String itemGroupKey) {
     ...
     * The key of items in language file.
     */
    public void setItemsKey(final String itemsKey) {
     ...
     * The key of recipe types in language file.
     */
    public void setRecipesKey(final String recipesKey) {
