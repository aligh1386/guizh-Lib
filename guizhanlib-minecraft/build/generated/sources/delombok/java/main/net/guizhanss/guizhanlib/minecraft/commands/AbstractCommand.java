...
public abstract class AbstractCommand {
     ...
     */
    protected AbstractCommand(@Nullable AbstractCommand parent, @Nonnull String name, @Nonnull BiFunction<AbstractCommand, CommandSender, String> description, @Nonnull String usage, @Nonnull SubCommand... subCommands) {
    ...
    public String getFullUsage(@Nonnull String label) {
        ...
        String cmd = layers.stream().map(command -> command instanceof BaseCommand ? label : command.getName()).collect(Collectors.joining(" ", "/", ""));
        cmd += " " + getUsage().get();
        return cmd;
    }
